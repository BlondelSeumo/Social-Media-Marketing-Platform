...
<section class="section">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
		  ...
		  <div class="breadcrumb-item"><a href="<?php echo base_url('comboposter/video_post/campaigns'); ?>"><?php echo $this->lang->line('Video post'); ?></a></div>
				...
				<div class="card">
			      	...
			      	<div class="card-body">
						<div class="card-footer padding-0">
							<button class="btn btn-lg btn-primary" post_type="video" action_type="<?php echo $post_action; ?>" id="submit_post" type="button"><i class="<?php echo $campaign_btn_icon ?>"></i> <?php echo $campaign_btn; ?> </button>

							<a class="btn btn-lg btn-light float-right" onclick='goBack("comboposter/video_post/campaigns",0)'><i class="fas fa-times"></i> <?php echo $this->lang->line("Cancel") ?> </a>
						</div>
			        </div>
				</div>          
