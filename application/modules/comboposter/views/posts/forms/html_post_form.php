				...
				<div class="row">
					<div class="col-12">
						<div class="form-group">
							...
							<textarea class="form-control" name="rich_content" id="rich_content_html_section"><?php if ($post_action == 'edit' || $post_action == 'clone') echo htmlspecialchars_decode($campaign_form_info['rich_content']); ?></textarea>
						</div>
					</div>
				</div>
