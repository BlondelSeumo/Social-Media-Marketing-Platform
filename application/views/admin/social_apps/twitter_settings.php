...
<section class="section">
	<div class="section-header">
		   ...
		   <div class="section-header-breadcrumb">
		     ...
		     <div class="breadcrumb-item"><a href="<?php echo base_url('social_apps/twitter_settings'); ?>"><?php echo $this->lang->line("Twitter"); ?></a></div>
	...
	<div class="row">
        <div class="col-12">
            <div class="card">
              <div class="card-body">
                  <b><?php echo $this->lang->line("Redirect URLs")."</b> : <span class='blue'>". base_url('comboposter/login_callback/twitter') ; ?></span><br/>
              </div>
            </div>
        </div>
    </div>
	        ...
	        <div class="card">
	          ...
	          <div class="card-body">              
	              <div class="form-group">
	                  ...
	                  <input name="app_name" value="<?php echo isset($twitter_settings['app_name']) ? $twitter_settings['app_name'] : set_value('app_name'); ?>"  class="form-control" type="text">              
	              ...
	              <div class="row">
		                <div class="col-12 col-md-6">
		                  <div class="form-group">
		                    ...
		                    <input name="consumer_id" value="<?php echo isset($twitter_settings['consumer_id']) ? $twitter_settings['consumer_id'] : set_value('consumer_id'); ?>" class="form-control" type="text">  
		                ...
		                <div class="col-12 col-md-6">
		                  <div class="form-group">
		                    ...
		                    <input name="consumer_secret" value="<?php echo isset($twitter_settings['consumer_secret']) ? $twitter_settings['consumer_secret'] : set_value('consumer_secret'); ?>" class="form-control" type="text">  
