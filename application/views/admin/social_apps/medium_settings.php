...
<section class="section">
	<div class="section-header">
		   ...
		   <div class="section-header-breadcrumb">
		     ...
		     <div class="breadcrumb-item"><a href="<?php echo base_url('social_apps/medium_settings'); ?>"><?php echo $this->lang->line("Medium Apps"); ?></a></div>
	...
	<div class="row">
        <div class="col-12">
            <div class="card">
              <div class="card-body">
                  <b><?php echo $this->lang->line("Redirect URLs")."</b> : <span class='blue'>". base_url('comboposter/login_callback/medium') ; ?></span><br/>
              </div>
            </div>
        </div>
    </div>
	...
	<div class="section-body">
	  <div class="row">
	    <div class="col-12">
	        <form action="<?php echo base_url("social_apps/medium_settings_update_action"); ?>" method="POST">
	        ...
	        <div class="card">
	          ...
	          <div class="card-body">              
	              <div class="form-group">
	                  ...
	                  <input name="app_name" value="<?php echo isset($medium_settings['app_name']) ? $medium_settings['app_name'] : set_value('app_name'); ?>"  class="form-control" type="text">              
	              ...
	              <div class="row">
		                <div class="col-12 col-md-6">
		                  <div class="form-group">
		                    ...
		                    <input name="client_id" value="<?php echo isset($medium_settings['client_id']) ? $medium_settings['client_id'] : set_value('client_id'); ?>" class="form-control" type="text">  
		                ...
		                <div class="col-12 col-md-6">
		                  <div class="form-group">
		                    ...
		                    <input name="client_secret" value="<?php echo isset($medium_settings['client_secret']) ? $medium_settings['client_secret'] : set_value('client_secret'); ?>" class="form-control" type="text">  
	              ...
	              <div class="form-group">
		        	  <?php	
		        	  $status =isset($medium_settings['status'])?$medium_settings['status']:"";
	                  if ($status == '') $status = '1';
		        	  ?>
