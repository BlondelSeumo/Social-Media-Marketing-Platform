...
$drop_menu = '<a href="'.$builder_load_url.'" class="float-right btn btn-primary" type="button" target="_BLANK"><i class="fas fa-plus-circle"></i> '.$this->lang->line("Set Keywords").'</a> <a data-toggle="tooltip" title="'.$this->lang->line("Use Classic Builder").'" href="" id="add_bot_settings" class="float-right btn btn-outline-primary mx-1" type="button"><i class="fas fa-plus-circle"></i></a>';
?> 
